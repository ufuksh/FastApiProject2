...
export declare class Info extends Command {
    ...
    static flags: {
        ...
        operations: import("@oclif/core/lib/interfaces").BooleanFlag<boolean>;
        schemas: import("@oclif/core/lib/interfaces").BooleanFlag<boolean>;
    ...
    private printSchemas;
    private printServers;
    private printSecuritySchemes;
}
