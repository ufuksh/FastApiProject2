...
exports.stripDefinition = exports.PRESETS = void 0;
 ...
 */
const stripDefinition = (document, options = {}) => {
    var _a, _b, _c, _d, _e, _f;
    const output = (0, klona_1.klona)(document);
    const opts = { ...exports.PRESETS[(_a = options.preset) !== null && _a !== void 0 ? _a : 'default'], ...options };
    ...
    if (opts.removeSchemas) {
        ...
        if ((_b = output.components) === null || _b === void 0 ? void 0 : _b.schemas) {
            delete output.components.schemas;
        }
        // recursively remove schemas
        const removeSchemas = (obj) => {
        ...
        if ((_c = output.components) === null || _c === void 0 ? void 0 : _c.requestBodies) {
            removeSchemas(output.components.requestBodies);
        }
        // remove schemas from requestBodies
        if ((_d = output.components) === null || _d === void 0 ? void 0 : _d.responses) {
            removeSchemas(output.components.responses);
        }
        // remove schemas from parameters
        if ((_e = output.components) === null || _e === void 0 ? void 0 : _e.parameters) {
    ...
    if (opts.removeSecuritySchemes) {
        ...
        if ((_f = output.components) === null || _f === void 0 ? void 0 : _f.securitySchemes) {
...
exports.stripDefinition = stripDefinition;
