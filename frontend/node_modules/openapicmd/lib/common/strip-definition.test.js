...
describe('stripDefinition', () => {
    it('should not modify original document', () => {
        ...
        // when
        const output = (0, strip_definition_1.stripDefinition)(document);
        // then
    ...
    describe('opts.replaceInfo', () => {
        it('should replace info', () => {
            ...
            const document = testFixtures.createDefinition();
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { replaceInfo: true });
            // then
    ...
    describe('opts.removeTags', () => {
        it('should remove tags from root', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { removeTags: true });
            // then
    ...
    describe('opts.removeDescriptions', () => {
        it('should remove descriptions from info', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { removeDescriptions: true, replaceInfo: false });
            // then
            expect(output.info).not.toHaveProperty('description');
        });
        it('should remove descriptions and summaries from path', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { removeDescriptions: true });
            // then
    ...
    describe('opts.removeExamples', () => {
        it('should remove examples from operations', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { removeExamples: true });
            // then
    ...
    describe('opts.removeExtensions', () => {
        it('should remove extensions from paths', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { removeExtensions: true });
            // then
    ...
    describe('opts.removeReadOnly', () => {
        it('should remove readOnly from schemas', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { removeReadOnly: true });
            // then
    ...
    describe('opts.removeSchemas', () => {
        it('should remove components.schemas', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { removeSchemas: true });
            // then
    ...
    describe('opts.removeSecuritySchemes', () => {
        it('should remove components.securitySchemes', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { removeSecuritySchemes: true });
            // then
    ...
    describe('opts.removeServers', () => {
        it('should remove servers', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { removeServers: true });
            // then
    ...
    describe('opts.firstServerOnly', () => {
        it('should remove all but the first server', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { firstServerOnly: true });
            // then
    ...
    describe('opts.replaceResponses', () => {
        it('should replace responses with minimal default response', () => {
            ...
            // when
            const output = (0, strip_definition_1.stripDefinition)(document, { replaceResponses: true });
            // then
