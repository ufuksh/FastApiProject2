...
class DtsGenerator {
    ...
    async getPostProcess(post) {
        ...
        for (const pc of post) {
            ...
            if (factory != null) {
                result.push(factory);
                debug('  post process plugin:', pc.plugin.meta.name, pc.plugin.meta.description);
            }
        }
        return result;
    }
    ...
    normalizeSchemaContent(content) {
        ...
        if (typeof content === 'boolean') {
            ...
            if (content.type === undefined &&
                ((_a = content.properties) !== null && _a !== void 0 ? _a : content.additionalProperties)) {
                content.type = 'object';
            }
            if (content.nullable) {
    ...
    generateArrayTypeProperty(schema, terminate = true) {
        ...
        if (items == null) {
            ...
            return additionalItemsNode === false
                ...
                : ast.buildSimpleArrayNode(additionalItemsNode !== null && additionalItemsNode !== void 0 ? additionalItemsNode : ast.buildAnyKeyword());
        }
